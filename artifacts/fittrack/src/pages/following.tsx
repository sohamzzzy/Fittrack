...
export default function UserFollowing() {
  ...
  const { data: users, isLoading } = useQuery({
    ...
    queryFn: () => customFetch(`/api/social/following/${userId}`, { responseType: "json" }) as Promise<any[]>,
    enabled: !!userId,
  });
  ...
  const handleFollowToggle = (u: any) => {
    ...
    qc.setQueryData(["/api/social/following", userId], (old: any) => 
    ...
    fn.mutate({ userId: u.id }, {
      ...
      onError: () => qc.invalidateQueries({ queryKey: ["/api/social/following", userId] })
    });
  };
