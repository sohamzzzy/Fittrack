...
export const getGetExerciseQueryKey = (exerciseId: number) => {
  return [`/api/exercises/${exerciseId}`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getExercise>>> = ({
    signal,
  }) => getExercise(exerciseId, { signal, ...requestOptions });
...
export const getExerciseHistory = async (
  ...
  return customFetch<ExerciseHistoryResult>(
...
export const getGetExerciseHistoryQueryKey = (exerciseId: number) => {
  return [`/api/exercises/${exerciseId}/history`] as const;
};
...
export const getGetRoutineQueryKey = (routineId: number) => {
  return [`/api/routines/${routineId}`] as const;
};
...
export const getAddWorkoutExerciseMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AddWorkoutExerciseMutationResult = NonNullable<
  Awaited<ReturnType<typeof addWorkoutExercise>>
>;
 ...
 */
export const getRemoveWorkoutExerciseUrl = (
  workoutId: number,
...
export const removeWorkoutExercise = async (
  ...
  return customFetch<void>(
    getRemoveWorkoutExerciseUrl(workoutId, workoutExerciseId),
    {
      ...options,
      method: "DELETE",
    },
...
export const getRemoveWorkoutExerciseMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type RemoveWorkoutExerciseMutationResult = NonNullable<
  Awaited<ReturnType<typeof removeWorkoutExercise>>
>;
 ...
 */
export const getAddSetUrl = (workoutId: number, workoutExerciseId: number) => {
...
export const updateSet = async (
  ...
  return customFetch<WorkoutSet>(
    getUpdateSetUrl(workoutId, workoutExerciseId, setId),
    {
      ...options,
      method: "PATCH",
      headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getUpdateSetMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateSetMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateSet>>
>;
...
export const deleteSet = async (
  ...
  return customFetch<void>(
    getDeleteSetUrl(workoutId, workoutExerciseId, setId),
    {
      ...options,
      method: "DELETE",
    },
...
export const getGetWorkoutSummaryQueryKey = () => {
  return [`/api/workouts/summary`] as const;
};
...
export type CreateFoodItemMutationResult = NonNullable<
  Awaited<ReturnType<typeof createFoodItem>>
>;
...
export const getGetFoodItemQueryKey = (foodItemId: number) => {
  return [`/api/nutrition/foods/${foodItemId}`] as const;
};

export const getGetFoodItemQueryOptions = <
  TData = Awaited<ReturnType<typeof getFoodItem>>,
  TError = ErrorType<unknown>,
>(
  foodItemId: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getFoodItem>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getFoodItem>>> = ({
    signal,
  }) => getFoodItem(foodItemId, { signal, ...requestOptions });
...
export type GetFoodItemQueryResult = NonNullable<
  Awaited<ReturnType<typeof getFoodItem>>
>;
...
export function useGetFoodItem<
  TData = Awaited<ReturnType<typeof getFoodItem>>,
  TError = ErrorType<unknown>,
>(
  foodItemId: number,
...
export type UpdateFoodItemMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateFoodItem>>
>;
...
export const getUpdateFoodLogMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateFoodLogMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateFoodLog>>
>;
...
export const getGetNutritionSummaryUrl = (
  params: GetNutritionSummaryParams,
) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/nutrition/summary?${stringifiedParams}`
...
export const getGetNutritionSummaryQueryKey = (
  ...
  return [`/api/nutrition/summary`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetNutritionSummaryQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getNutritionSummary>>
  > = ({ signal }) =>
    getNutritionSummary(params, { signal, ...requestOptions });
...
export const setNutritionGoals = async (
  nutritionGoalsInput: NutritionGoalsInput,
  options?: RequestInit,
): Promise<NutritionGoals> => {
...
export const getSetNutritionGoalsMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type SetNutritionGoalsMutationResult = NonNullable<
  Awaited<ReturnType<typeof setNutritionGoals>>
>;
...
export const getGetPostQueryKey = (postId: number) => {
  return [`/api/social/posts/${postId}`] as const;
};
